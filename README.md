...
* 🎮 **[GPU Requirements & Parameter Tuning Guide](GPU_REQUIREMENTS_AND_TUNING.md)**: Hardware tier guide (4GB, 6GB, 8GB, 16GB+), VRAM consumption breakdown, and exact parameters to tune.
* 🔍 **[Changes From Original Repository](CHANGES_FROM_ORIGINAL.md)**: Transparent summary of the 3 compatibility fixes made vs. the upstream EACL 2024 repository.
