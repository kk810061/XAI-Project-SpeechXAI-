    ...
    def explain(
        ...
        # elif:
            ...
            if methodology not in self.explainers:
                raise ValueError(
                    f'Explainer {methodology} not supported. Choose between "LOO", "Gradient", "GradientXInput", "LIME", "perturb_paraling", "Random"'
                )
            ...
            elif "Random" in methodology:
                explainer_args["seed"] = seed
            else:
